...
namespace RiggVar.FR
{
    ...
    public class TStringList : TStrings 
    {
        ...
        protected override int CompareStrings(string s1, string s2) {
            return string.Compare(s1, s2); //String.Compare(s1, s2, !FCaseSensitive);
        }
        ...
        {            
            ...
            {
                TStringItem t = (TStringItem)o;
                FList.Insert(i, t);
            }
        }    
        
        private /*override*/ void CopyTo2(TStringItem[] a, int i) {
            FList.CopyTo(a, i);
        }    
